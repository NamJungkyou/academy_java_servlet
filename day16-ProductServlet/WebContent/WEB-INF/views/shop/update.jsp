...
<body>
	...
	<form action="update" method="post">
		<table>
			<tr>
				<th>제품코드</th>
				<td><input name="prodCode" type="text" readonly="readonly"
			...
			<tr>
				<td colspan="2" style="text-aling: center;"><a href="list">목록보기</a>
					<a href="detail?prodCode=${product.prodCode}">수정 취소</a> <input
					type="submit" value="저장" /> <input type="reset" value="초기화" /></td>
			</tr>
		</table>
	</form>
</body>
